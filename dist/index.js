...
var Button = forwardRef(function Button2({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    loading && /* @__PURE__ */ React.createElement(Loader2, { className: "animate-spin", size: size === "sm" ? 14 : size === "lg" ? 20 : 16 }),
...
var Checkbox = forwardRef3(function Checkbox2({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("span", { className: "relative inline-flex items-center justify-center" }, /* @__PURE__ */ React.createElement(
      ...
      indeterminate ? /* @__PURE__ */ React.createElement(Minus, { size: iconSize, strokeWidth: 3 }) : checked ? /* @__PURE__ */ React.createElement(Check, { size: iconSize, strokeWidth: 3 }) : null
    )),
...
var Tag = forwardRef6(function Tag2({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    dismissible && /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(X, { size: size === "sm" ? 10 : 12 })
    )
  );
});
Tag.displayName = "Tag";
...
var Notification = forwardRef7(function Notification2({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    dismissible && /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(X2, { size: 16, style: { color: config.iconColor } })
    )
  );
});
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement(X2, { size: 16, style: { color: "var(--ds-icon-secondary)" } })
      )
    )
  );
}
...
function NavItem({ item, collapsed, depth = 0 }) {
  ...
  return /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement(
    ...
    !collapsed && hasChildren && /* @__PURE__ */ React.createElement("span", { className: "shrink-0" }, expanded ? /* @__PURE__ */ React.createElement(ChevronDown2, { size: 14 }) : /* @__PURE__ */ React.createElement(ChevronRight, { size: 14 }))
...
var Breadcrumb = forwardRef11(function Breadcrumb2({ items = [], separator, className = "", ...props }, ref) {
  const SeparatorIcon = separator || /* @__PURE__ */ React.createElement(ChevronRight2, { size: 14, style: { color: "var(--ds-text-tertiary)" } });
  ...
  const modal = /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      (title || showCloseButton) && /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between px-6 py-4 border-b border-[var(--ds-border-primary)] shrink-0" }, title && /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement(X3, { size: 18, style: { color: "var(--ds-icon-secondary)" } })
      )),
  ...
  return /* @__PURE__ */ React.createElement("div", { ref: containerRef, className: ["flex flex-col gap-1.5 relative", wrapperClassName].join(" ") }, label && /* @__PURE__ */ React.createElement(
    ...
    options.map((opt) => {
      ...
      return /* @__PURE__ */ React.createElement(
        ...
        isSelected && /* @__PURE__ */ React.createElement(Check2, { size: 16, style: { color: "var(--ds-icon-brand)" } })
      );
    }),
...
var OverflowMenu = forwardRef15(function OverflowMenu2({
  ...
  return /* @__PURE__ */ React.createElement("div", { ref: containerRef, className: ["relative inline-flex", className].join(" "), ...props }, trigger ? /* @__PURE__ */ React.createElement("span", { onClick: () => setIsOpen(!isOpen), className: "cursor-pointer" }, trigger) : /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(MoreVertical, { size: iconSize, style: { color: "var(--ds-icon-secondary)" } })
  ), isOpen && /* @__PURE__ */ React.createElement(
    "div",
    {
      role: "menu",
...
var DatePicker = forwardRef16(function DatePicker2({
  ...
  return /* @__PURE__ */ React.createElement("div", { ref: containerRef, className: ["flex flex-col gap-1.5 relative", wrapperClassName].join(" ") }, label && /* @__PURE__ */ React.createElement("label", { htmlFor: id, className: "text-[length:var(--ds-text-sm)] font-medium text-[var(--ds-text-primary)]" }, label, required && /* @__PURE__ */ React.createElement("span", { className: "text-[var(--ds-text-danger)] ml-0.5" }, "*")), /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-3" }, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(ChevronLeft, { size: 16, style: { color: "var(--ds-icon-primary)" } })
      ...
      /* @__PURE__ */ React.createElement(ChevronRight3, { size: 16, style: { color: "var(--ds-icon-primary)" } })
    )),
...
var Search = forwardRef18(function Search2({
  ...
  return /* @__PURE__ */ React.createElement("div", { ref: containerRef, className: ["relative", wrapperClassName].join(" ") }, /* @__PURE__ */ React.createElement("div", { className: "relative" }, /* @__PURE__ */ React.createElement(
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: "absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1" }, loading && /* @__PURE__ */ React.createElement(Loader23, { size: iconSize, className: "animate-spin", style: { color: "var(--ds-icon-secondary)" } }), searchValue && !loading && /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
      onClick: handleClear,
    ...
    /* @__PURE__ */ React.createElement(X4, { size: iconSize, style: { color: "var(--ds-icon-secondary)" } })
...
var Pagination = forwardRef19(function Pagination2({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("nav", { className: "flex items-center gap-1", "aria-label": "Pagination" }, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(ChevronsLeft, { size: 16, style: { color: "var(--ds-icon-primary)" } })
    ), /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
      ...
      /* @__PURE__ */ React.createElement(ChevronLeft2, { size: 16, style: { color: "var(--ds-icon-primary)" } })
    ), pages.map(
      ...
      /* @__PURE__ */ React.createElement(ChevronRight4, { size: 16, style: { color: "var(--ds-icon-primary)" } })
    ), /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
      ...
      /* @__PURE__ */ React.createElement(ChevronsRight, { size: 16, style: { color: "var(--ds-icon-primary)" } })
    ))
  );
});
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "overflow-x-auto ds-scrollbar" }, /* @__PURE__ */ React.createElement("table", { className: "w-full border-collapse" }, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("tr", { style: { backgroundColor: "var(--ds-table-header-bg)" } }, selectable && /* @__PURE__ */ React.createElement("th", { className: `${cellPadding} w-12` }, /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("span", { className: "inline-flex items-center gap-1.5" }, col.header, sortable && col.sortable !== false && /* @__PURE__ */ React.createElement("span", { className: "inline-flex" }, sortColumn === col.key ? sortDirection === "asc" ? /* @__PURE__ */ React.createElement(ArrowUp, { size: 14 }) : /* @__PURE__ */ React.createElement(ArrowDown, { size: 14 }) : /* @__PURE__ */ React.createElement(ArrowUpDown, { size: 14, className: "opacity-30" })))
      )))
      ...
      return /* @__PURE__ */ React.createElement(
        ...
        columns.map((col) => {
          ...
          return /* @__PURE__ */ React.createElement(
            ...
            ), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: commitEdit, className: "p-0.5 text-[var(--ds-icon-success)] cursor-pointer" }, /* @__PURE__ */ React.createElement(Check3, { size: 14 })), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: cancelEdit, className: "p-0.5 text-[var(--ds-icon-danger)] cursor-pointer" }, /* @__PURE__ */ React.createElement(XIcon, { size: 14 }))) : col.render ? col.render(cellValue, row, globalIndex) : /* @__PURE__ */ React.createElement("span", null, cellValue)
          );
        })
      );
    })))),
...
function BarChart({
  ...
  if (variant === "diverging") {
    return /* @__PURE__ */ React.createElement(ChartWrapper, { title, subtitle, className }, /* @__PURE__ */ React.createElement(ResponsiveContainer, { width: "100%", height }, /* @__PURE__ */ React.createElement(RechartsBarChart, { data, ...rest }, showGrid && /* @__PURE__ */ React.createElement(CartesianGrid, { ...gridProps }), /* @__PURE__ */ React.createElement(XAxis, { dataKey: xAxisKey, ...axisProps }), /* @__PURE__ */ React.createElement(YAxis, { ...axisProps }), showTooltip && /* @__PURE__ */ React.createElement(Tooltip, { ...tooltipProps }), shouldShowLegend && /* @__PURE__ */ React.createElement(Legend, { ...legendProps }), /* @__PURE__ */ React.createElement(ReferenceLine, { y: 0, stroke: isDark ? "#6b7280" : "#9ca3af" }), dataKeys.map((key) => /* @__PURE__ */ React.createElement(Bar, { key, dataKey: key, radius: verticalRadius }, data.map((entry, idx) => {
  ...
  if (variant === "waterfall") {
    return /* @__PURE__ */ React.createElement(ChartWrapper, { title, subtitle, className }, /* @__PURE__ */ React.createElement(ResponsiveContainer, { width: "100%", height }, /* @__PURE__ */ React.createElement(RechartsBarChart, { data: waterfallData, ...rest }, showGrid && /* @__PURE__ */ React.createElement(CartesianGrid, { ...gridProps }), /* @__PURE__ */ React.createElement(XAxis, { dataKey: xAxisKey, ...axisProps }), /* @__PURE__ */ React.createElement(YAxis, { ...axisProps }), showTooltip && /* @__PURE__ */ React.createElement(
      Tooltip,
      {
        ...tooltipProps,
    ...
    ), /* @__PURE__ */ React.createElement(Bar, { dataKey: "__base", stackId: "waterfall", fill: "transparent", radius: 0 }), /* @__PURE__ */ React.createElement(Bar, { dataKey: "__value", stackId: "waterfall", radius: verticalRadius }, waterfallData.map((entry, idx) => {
      let fill = CHART_COLORS.blue[500];
      if (!entry.__isTotal) {
        fill = (entry.__rawValue ?? 0) >= 0 ? CHART_COLORS.green[500] : CHART_COLORS.red[500];
      }
      return /* @__PURE__ */ React.createElement(Cell, { key: idx, fill });
    })))));
  }
  if (variant === "stacked-percent") {
    return /* @__PURE__ */ React.createElement(ChartWrapper, { title, subtitle, className }, /* @__PURE__ */ React.createElement(ResponsiveContainer, { width: "100%", height }, /* @__PURE__ */ React.createElement(RechartsBarChart, { data: percentData, ...rest }, showGrid && /* @__PURE__ */ React.createElement(CartesianGrid, { ...gridProps }), /* @__PURE__ */ React.createElement(XAxis, { dataKey: xAxisKey, ...axisProps }), /* @__PURE__ */ React.createElement(YAxis, { ...axisProps, domain: [0, 100], tickFormatter: (v) => `${v}%` }), showTooltip && /* @__PURE__ */ React.createElement(
      Tooltip,
      {
        ...tooltipProps,
    ...
    ), shouldShowLegend && /* @__PURE__ */ React.createElement(Legend, { ...legendProps }), dataKeys.map((key, i) => /* @__PURE__ */ React.createElement(
      Bar,
      {
        key,
        dataKey: key,
  ...
  if (isHorizontal) {
    return /* @__PURE__ */ React.createElement(ChartWrapper, { title, subtitle, className }, /* @__PURE__ */ React.createElement(ResponsiveContainer, { width: "100%", height }, /* @__PURE__ */ React.createElement(RechartsBarChart, { data, layout: "vertical", ...rest }, showGrid && /* @__PURE__ */ React.createElement(CartesianGrid, { ...gridProps, horizontal: false, vertical: true }), /* @__PURE__ */ React.createElement(XAxis, { type: "number", ...axisProps }), /* @__PURE__ */ React.createElement(YAxis, { type: "category", dataKey: xAxisKey, ...axisProps, width: 80 }), showTooltip && /* @__PURE__ */ React.createElement(Tooltip, { ...tooltipProps }), shouldShowLegend && /* @__PURE__ */ React.createElement(Legend, { ...legendProps }), dataKeys.map((key, i) => /* @__PURE__ */ React.createElement(
      Bar,
      {
        key,
        dataKey: key,
...
function LineChart({
  ...
  return /* @__PURE__ */ React.createElement(ChartWrapper, { title, subtitle, className }, /* @__PURE__ */ React.createElement(ResponsiveContainer2, { width: "100%", height }, /* @__PURE__ */ React.createElement(RechartsLineChart, { data }, showGrid && /* @__PURE__ */ React.createElement(CartesianGrid2, { ...getGridProps(isDark) }), /* @__PURE__ */ React.createElement(XAxis2, { dataKey: xAxisKey, ...getAxisProps(isDark) }), /* @__PURE__ */ React.createElement(YAxis2, { ...getAxisProps(isDark) }), showTooltip && /* @__PURE__ */ React.createElement(Tooltip2, { ...getTooltipProps(isDark) }), legendVisible && /* @__PURE__ */ React.createElement(Legend2, { ...getLegendProps(isDark) }), variant === "with-threshold" && thresholdValue != null && /* @__PURE__ */ React.createElement(
    ReferenceLine2,
    {
      y: thresholdValue,
...
function AreaChart({
  ...
  return /* @__PURE__ */ React.createElement(ChartWrapper, { title, subtitle, className }, /* @__PURE__ */ React.createElement(ResponsiveContainer3, { width: "100%", height }, /* @__PURE__ */ React.createElement(RechartsAreaChart, { data: chartData }, renderDefs(), showGrid && /* @__PURE__ */ React.createElement(CartesianGrid3, { ...getGridProps(isDark) }), /* @__PURE__ */ React.createElement(XAxis3, { dataKey: xAxisKey, ...getAxisProps(isDark) }), /* @__PURE__ */ React.createElement(
    YAxis3,
    {
      ...getAxisProps(isDark),
  ...
  ), legendVisible && /* @__PURE__ */ React.createElement(Legend3, { ...getLegendProps(isDark) }), renderAreas())));
}
...
function PieChart({
  ...
  const renderChart = () => {
    ...
    switch (variant) {
      case "standard":
        return /* @__PURE__ */ React.createElement(ResponsiveContainer4, { width: "100%", height }, /* @__PURE__ */ React.createElement(RechartsPieChart, null, /* @__PURE__ */ React.createElement(
          Pie,
          {
            data,
            cx,
          ...
          data.map((entry, index) => /* @__PURE__ */ React.createElement(Cell2, { key: `cell-${index}`, fill: resolvedColors[index] }))
        ), showTooltip && /* @__PURE__ */ React.createElement(Tooltip4, { ...tooltipProps }), showLegend && /* @__PURE__ */ React.createElement(Legend4, { ...legendProps })));
      case "donut":
        return /* @__PURE__ */ React.createElement(ResponsiveContainer4, { width: "100%", height }, /* @__PURE__ */ React.createElement(RechartsPieChart, null, /* @__PURE__ */ React.createElement(
          Pie,
          {
          ...
          data.map((entry, index) => /* @__PURE__ */ React.createElement(Cell2, { key: `cell-${index}`, fill: resolvedColors[index] }))
        ), renderCenterText("50%", height / 2 - (showLegend ? 15 : 0)), showTooltip && /* @__PURE__ */ React.createElement(Tooltip4, { ...tooltipProps }), showLegend && /* @__PURE__ */ React.createElement(Legend4, { ...legendProps })));
      case "semi":
        return /* @__PURE__ */ React.createElement(ResponsiveContainer4, { width: "100%", height }, /* @__PURE__ */ React.createElement(RechartsPieChart, null, /* @__PURE__ */ React.createElement(
          Pie,
          {
          ...
          data.map((entry, index) => /* @__PURE__ */ React.createElement(Cell2, { key: `cell-${index}`, fill: resolvedColors[index] }))
        ), renderCenterText("50%", cyNum), showTooltip && /* @__PURE__ */ React.createElement(Tooltip4, { ...tooltipProps }), showLegend && /* @__PURE__ */ React.createElement(Legend4, { ...legendProps })));
      case "nested":
        return /* @__PURE__ */ React.createElement(ResponsiveContainer4, { width: "100%", height }, /* @__PURE__ */ React.createElement(RechartsPieChart, null, /* @__PURE__ */ React.createElement(
          Pie,
          {
          ...
          data.map((entry, index) => /* @__PURE__ */ React.createElement(Cell2, { key: `inner-${index}`, fill: resolvedColors[index] }))
        ), /* @__PURE__ */ React.createElement(
          Pie,
          {
            data: outerData,
          ...
          outerData.map((entry, index) => /* @__PURE__ */ React.createElement(Cell2, { key: `outer-${index}`, fill: resolvedOuterColors[index] }))
        ), showTooltip && /* @__PURE__ */ React.createElement(Tooltip4, { ...tooltipProps }), showLegend && /* @__PURE__ */ React.createElement(Legend4, { ...legendProps })));
      default:
        return null;
    }
...
function ComposedChart({
  ...
  const renderBarLine = () => {
    ...
    return /* @__PURE__ */ React.createElement(ResponsiveContainer5, { width: "100%", height }, /* @__PURE__ */ React.createElement(RechartsComposedChart, { data }, showGrid && /* @__PURE__ */ React.createElement(CartesianGrid4, { ...gridProps }), /* @__PURE__ */ React.createElement(XAxis4, { dataKey: xAxisKey, ...axisProps }), /* @__PURE__ */ React.createElement(
      YAxis4,
      {
        yAxisId: "left",
        ...axisProps,
    ...
    ), showTooltip && /* @__PURE__ */ React.createElement(Tooltip5, { ...tooltipProps }), showLegend && /* @__PURE__ */ React.createElement(Legend5, { ...legendProps }), barKeys.map((key, i) => /* @__PURE__ */ React.createElement(
      Bar2,
      {
        key,
        dataKey: key,
  ...
  const renderBarArea = () => {
    ...
    ), showTooltip && /* @__PURE__ */ React.createElement(Tooltip5, { ...tooltipProps }), showLegend && /* @__PURE__ */ React.createElement(Legend5, { ...legendProps }), areaKeys.map((key) => {
...
function RadialChart({
  ...
  if (variant === "gauge") {
    ...
    return /* @__PURE__ */ React.createElement(ChartWrapper, { title, subtitle, className }, /* @__PURE__ */ React.createElement(ResponsiveContainer6, { width: "100%", height }, /* @__PURE__ */ React.createElement(
      RadialBarChart,
      {
        cx: "50%",
        cy: "55%",
      ...
      showTooltip && /* @__PURE__ */ React.createElement(Tooltip6, { ...getTooltipProps(isDark) }),
      showLegend && /* @__PURE__ */ React.createElement(Legend6, { ...getLegendProps(isDark) })
    )));
  }
  if (variant === "progress") {
    const clampedValue = Math.min(Math.max(value, 0), maxValue);
  ...
  if (variant === "multi-ring") {
    ...
    return /* @__PURE__ */ React.createElement(ChartWrapper, { title, subtitle, className }, /* @__PURE__ */ React.createElement(ResponsiveContainer6, { width: "100%", height }, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(
        ...
        ringData.map((entry, i) => /* @__PURE__ */ React.createElement(Cell3, { key: `cell-${i}`, fill: entry.fill }))
      ),
      showTooltip && /* @__PURE__ */ React.createElement(Tooltip6, { ...getTooltipProps(isDark) }),
      /* @__PURE__ */ React.createElement(Legend6, { ...getLegendProps(isDark) })
    )));
  }
  if (variant === "radar") {
    return /* @__PURE__ */ React.createElement(ChartWrapper, { title, subtitle, className }, /* @__PURE__ */ React.createElement(ResponsiveContainer6, { width: "100%", height }, /* @__PURE__ */ React.createElement(RadarChart, { cx: "50%", cy: "50%", outerRadius: "75%", data }, /* @__PURE__ */ React.createElement(
      PolarGrid,
      {
    ...
    }), showTooltip && /* @__PURE__ */ React.createElement(Tooltip6, { ...getTooltipProps(isDark) }), showLegend && /* @__PURE__ */ React.createElement(Legend6, { ...getLegendProps(isDark) }))));
  }
...
var ActivityFeed = forwardRef22(function ActivityFeed2({ items = [], maxHeight, className = "", ...props }, ref) {
  return /* @__PURE__ */ React.createElement(
    ...
    items.map((item, i) => /* @__PURE__ */ React.createElement("div", { key: item.id ?? i, className: "flex gap-3 py-3 px-2" }, /* @__PURE__ */ React.createElement("div", { className: "shrink-0 mt-1.5" }, /* @__PURE__ */ React.createElement(
      "div",
      {
...
var RankedList = forwardRef22(function RankedList2({ items = [], valueLabel, className = "", ...props }, ref) {
  return /* @__PURE__ */ React.createElement(
    ...
    items.map((item, i) => /* @__PURE__ */ React.createElement("div", { key: item.id ?? i, className: "flex items-center gap-3 py-2.5 px-2" }, /* @__PURE__ */ React.createElement(
      "span",
      {
...
var TableList = forwardRef22(function TableList2({
  ...
  const SortIcon = ({ colKey }) => {
    ...
    if (sortCol !== colKey) return /* @__PURE__ */ React.createElement(ChevronsUpDown, { size: 12, style: { color: "var(--ds-icon-secondary)", opacity: 0.5 } });
    return sortDir === "asc" ? /* @__PURE__ */ React.createElement(ChevronUp, { size: 12, style: { color: "var(--ds-text-brand)" } }) : /* @__PURE__ */ React.createElement(ChevronDown4, { size: 12, style: { color: "var(--ds-text-brand)" } });
  };
